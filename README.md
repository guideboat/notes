...
3. Open `index.html` in a web browser to access the login page.
4. Use valid credentials to sign in and access the chat interface.

## Usage
- **Sign In**: Enter your email and password on the login page to authenticate.
